...
def add_customer():
    ...
    if form.validate_on_submit():
        customer = Customer(name=form.name.data,
                            ...
                            products=form.products.data.name,
                            frequency=form.frequency.data.name,
...
def edit_customer(id):
    ...
    if form.validate_on_submit():
        ...
        customer.products = form.products.data.name
        customer.frequency = form.frequency.data.name
    ...
    form.products.data.name = customer.products
    form.frequency.data.name = customer.frequency
